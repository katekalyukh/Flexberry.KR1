...
namespace IIS.KR1
{
    ...
    public class Заказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KR1.ВидНосителя fНоситель;
        
        private IIS.KR1.Фотокиоск fФотокиоск;
        
        private IIS.KR1.Клиент fКлиент;
        
        private IIS.KR1.DetailArrayOfФото fФото;
        ...
        public virtual IIS.KR1.ВидНосителя Носитель
        {
            get
            {
                ...
                IIS.KR1.ВидНосителя result = this.fНоситель;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.KR1.Клиент Клиент
        {
            get
            {
                ...
                IIS.KR1.Клиент result = this.fКлиент;
        ...
        [PropertyStorage(new string[] {
                "Фотокиоск"})]
        [NotNull()]
        public virtual IIS.KR1.Фотокиоск Фотокиоск
        {
            get
            {
                ...
                IIS.KR1.Фотокиоск result = this.fФотокиоск;
        ...
        public virtual IIS.KR1.DetailArrayOfФото Фото
        {
            get
            {
                ...
                if ((this.fФото == null))
                {
                    this.fФото = new IIS.KR1.DetailArrayOfФото(this);
                }
                IIS.KR1.DetailArrayOfФото result = this.fФото;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.KR1.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.KR1.Заказ));
                }
            }
        }
    }
