...
namespace IIS.KR1
{
    ...
    [View("ФотоE", new string[] {
            ...
            "Заказ.Фотокиоск.Товары",
            "Заказ.Фотокиоск.Товары.Вид as \'Вид товара\'",
    ...
    public class Фото : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.KR1.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.KR1.Заказ Заказ
        {
            get
            {
                ...
                IIS.KR1.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФотоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотоE", typeof(IIS.KR1.Фото));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФотоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотоL", typeof(IIS.KR1.Фото));
                }
            }
        }
    }
    ...
    public class DetailArrayOfФото : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.KR1.DetailArrayOfФото members)

        // *** End programmer edit section *** (IIS.KR1.DetailArrayOfФото members)
        ...
        /// </summary>
        public DetailArrayOfФото(IIS.KR1.Заказ fЗаказ) : 
                base(typeof(Фото), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.KR1.Фото this[int index]
        {
            get
            {
                return ((IIS.KR1.Фото)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.KR1.Фото dataobject)
        {
