...
namespace IIS.KR1
{
    ...
    public class Фотокиоск : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KR1.Товары fТовары;
        ...
        [PropertyStorage(new string[] {
                "Товары"})]
        [NotNull()]
        public virtual IIS.KR1.Товары Товары
        {
            get
            {
                ...
                IIS.KR1.Товары result = this.fТовары;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФотокиоскE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотокиоскE", typeof(IIS.KR1.Фотокиоск));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФотокиоскL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотокиоскL", typeof(IIS.KR1.Фотокиоск));
                }
            }
        }
    }
